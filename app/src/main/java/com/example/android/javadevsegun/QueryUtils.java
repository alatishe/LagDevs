...
import static com.example.android.javadevsegun.MainActivity.LOG_TAG;
...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link DevsList} objects that has been built up from
     * parsing a JSON response.
     */

    public static List<DevsList> fetchDevelopersData(String requestUrl) {
        // Create URL object
        ...
        List<DevsList> devs = extractDevelopers(jsonResponse);

        // Return the {@link Event}
        return devs;
    }

    public static List<DevsList> extractDevelopers(String devsJSON) {
        ...
        List<DevsList> devs = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < devsArray.length(); i++) {
                ...
                //
                DevsList dev = new DevsList(login, url, avatar_url);
