...
public class MainActivity extends AppCompatActivity {
    ...
    private DevsListAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new DevsListAdapter(this, new ArrayList<DevsList>());
        ...
        devListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                DevsList currentDeveloper = mAdapter.getItem(position);
    ...
    private class DevelopersAsyncTask extends AsyncTask<String, Void, List<DevsList>> {
         ...
         */
        @Override
        protected List<DevsList> doInBackground(String... urls) {
            if(urls.length < 1 || urls[0] == null) {
                return null;
            }

            List<DevsList> result = QueryUtils.fetchDevelopersData(urls[0]);
            return result;
        }

        @Override
        protected void onPostExecute(List<DevsList> data) {
